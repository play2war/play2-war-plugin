...
class Play2Servlet31RequestHandler(servletRequest: HttpServletRequest)
  ...
  asyncContext.addListener(asyncListener) // TODO #321 do we need to set that explicitly?
...
//  }
//
//  override protected def pushPlayResultToServletOS(futureResult: Future[Result])(implicit mat: Materializer, executionContext: ExecutionContext): Unit = {
